...
MIDDLEWARE = [
    ...
    'backend.middleware.image_fix_middleware.CleanImageMiddleware', 
...
# Explicitly include content-disposition (needed for file downloads)
CORS_ALLOW_HEADERS = list(default_headers) + [
    "content-disposition",
]

# Explicitly include methods (your list is fine too)
